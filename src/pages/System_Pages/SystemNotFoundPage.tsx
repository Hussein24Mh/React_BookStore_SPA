	...
	return (
		<div className="min-h-screen w-full bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center px-4 m-auto">
			<div className="text-center max-w-lg">
				...
				{/* Glitchy subtitle */}
				<h1 className="text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">Page not found</h1>
				...
				{/* Hidden easter egg */}
				<p className="text-gray-500 text-sm mt-8">(Psst… even the best explorers get lost sometimes)</p>
			</div>
		</div>
	);
}
